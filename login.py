...
class Login_window:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file="Image\\login_background.jpg")
        lbl_bg=Label(self.root,image=self.bg)
        lbl_bg.place(x=0,y=0,relwidth=1,relheight=1)

        frame = Frame(self.root,bg="black")
        frame.place(x=600,y=150,width=340,height=450)
        
        img1=Image.open("Image\\login_icon.ico")
        ...
        ########## ICON IMAGES ###############
        img2=Image.open("Image\\login_icon.ico")
        img2=img2.resize((25,25),Image.LANCZOS)
        self.photoimage2=ImageTk.PhotoImage(img2)
        lblimg2=Label(image=self.photoimage2,bg="black",borderwidth=0)
        lblimg2.place(x=610,y=306,width=25,height=25)

        img3=Image.open("Image\\password_icon.ico")
        img3=img3.resize((25,25),Image.LANCZOS)
        self.photoimage3=ImageTk.PhotoImage(img3)
        lblimg3=Label(image=self.photoimage3,bg="black",borderwidth=0)
        lblimg3.place(x=610,y=386,width=25,height=25)
################### IMAGE BUTTON ###   #################
        img4=Image.open("Image\\exit1.png")
        img4=img4.resize((90,90),Image.LANCZOS)
        self.photoimage4=ImageTk.PhotoImage(img4)
        lblimg4=Button(image=self.photoimage4,bg="black",borderwidth=0, cursor="hand2",command=self.Exit)
        lblimg4.place(x=850,y=166,width=80,height=25)
        
##################### BUTTON ################################

        login_btn=Button(frame,text="LOGIN",command=self.login,font=("arial",11,"bold"), cursor="hand2",bd=3,relief=RIDGE,fg="white",bg="blue",activeforeground="white",activebackground="blue")
        login_btn.place(x=110,y=320,width=120,height=35)

        register_btn=Button(frame,text="REGISTER",command=self.register_window, cursor="hand2",font=("arial",11,"bold"),borderwidth=0,relief=RIDGE,fg="white",bg="black",activeforeground="white",activebackground="black")
        register_btn.place(x=2,y=370,width=120,height=20)

        forgot_password_btn=Button(frame,text="FORGOT PASSWORD", cursor="hand2",command=self.forgot_password_window,font=("arial",11,"bold"),borderwidth=0,relief=RIDGE,fg="white",bg="black",activeforeground="white",activebackground="black")
    ...
    def reset_password_data(self):
        if self.combo_security_q.get()=="SELECT":
            ...
            if row==None:
                ...
                conn.commit()
                conn.close()
                messagebox.showinfo("INFO","YOUR PASSWORD HAS BEEN RESET, PLAESE LOFIN NEW PASSWORD",parent=self.root2)
                self.root2.destroy()
    ...
    def forgot_password_window(self):
        if self.txtuser.get()=="":
            ...
            if row==None:
                ...
                self.root2.geometry("440x450+610+170")
...
class Register:
    def __init__(self,root):
        ...
        ###### BG IMAGE ##########
        self.bg=ImageTk.PhotoImage(file="Image\\register_background.jpg")

        bg_lbl=Label(self.root,image=self.bg)
        bg_lbl.place(x=0,y=0,relheight=1,relwidth=1)

        ########## LEFT IMAGE #############
        self.bg1=ImageTk.PhotoImage(file="Image\\register_left_background.jpg")

        left_lbl=Label(self.root,image=self.bg1)
        left_lbl.place(x=110,y=100,height=550,width=470)
        ...
        ########### BUTTON #############
        img = Image.open("Image\\register_button.png")
        ...
        img1 = Image.open("Image\\login_button.png")
        ...
        img2 = Image.open("Image\\exit.png")
        img2 = img2.resize((80,80),Image.LANCZOS)
        self.photoimage2=ImageTk.PhotoImage(img2)
        b2 = Button(frame,command=self.return_login,image=self.photoimage2,borderwidth=0,cursor="hand2",fg="white",activeforeground="white",activebackground="white",bg="white",font=("arial",15,"bold"))
        b2.place(x=650,y=5)
    ...
    def rgister_data(self):
        if self.var_fname.get()=="" or self.var_email.get()=="" or self.var_security_q.get()=="SELECT":
            ...
            row=my_cursor.fetchone()
            if row!=None:
                messagebox.showerror("ERROR","USER ALREADY EXIST, PLEASE TRY ANOTHERS EMAIL!!!",parent=self.root)
            else:
                ...
                conn.commit()
                conn.close()
                messagebox.showinfo("SUCCESS","REGISER SUCCESSFULLY!!!",parent=self.root)
